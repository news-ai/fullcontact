...
FullContact.Verification = require('./endpoints/verification');
...
FullContact.define(FullContact.prototype, 'verification', function define() {
  return new FullContact.Verification(this);
});
